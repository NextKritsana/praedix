...
source_path: "E:\\ProJect\\ACS File\\advance\\Digital Forensic\\Project Digital Forensic  Copy\\integration-forenchain-frontend-main\\src\\components\\SignUp.jsx"
source_size_bytes: 9036
...
- Source: [SignUp.jsx](file:///E:/ProJect/ACS%20File/advance/Digital%20Forensic/Project%20Digital%20Forensic%20%20Copy/integration-forenchain-frontend-main/src/components/SignUp.jsx)
...
export default function SignUpTailwind() {
  const [formData, setFormData] = useState({
    username: "", // Changed from firstName/lastName/email
    password: "",
    confirmPassword: "",
  });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-slate-50 text-slate-900">
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-white rounded-2xl shadow-lg border border-slate-200">
        ...
        <p className="text-sm text-slate-600 mb-6">
          Create your account to start your investigation securely.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Rest of your form remains the same for password fields */}
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">
              Password
            </label>
          ...
          {/* Terms and conditions and submit button remain the same */}
          <div className="flex items-center gap-2 text-sm">
            <input type="checkbox" required className="h-4 w-4 rounded border-slate-300 text-sky-500 focus:ring-sky-400" />
