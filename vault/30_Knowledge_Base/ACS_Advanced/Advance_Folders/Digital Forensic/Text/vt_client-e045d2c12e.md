...
source_path: "E:\\ProJect\\ACS File\\advance\\Digital Forensic\\Project Digital Forensic  Copy\\integration-forenchain-backend-main\\vt_client.py"
source_size_bytes: 4226
source_modified: 2025-11-30T18:39:56
...
- Source: [vt_client.py](file:///E:/ProJect/ACS%20File/advance/Digital%20Forensic/Project%20Digital%20Forensic%20%20Copy/integration-forenchain-backend-main/vt_client.py)
...
# In vt_client.py - FIX the scan_hash function
def scan_hash(file_hash: str) -> dict:
    """Scan file hash and return AnalysisResult object"""
    if not VT_API_KEY:
        ...
        return {
            ...
            "summary": "VirusTotal API key is missing."
        }
    
    _wait_for_rate_limit()
    print(f"[VT Client] Scanning Hash: {file_hash}")
    ...
    try:
        ...
        if response.status_code == 401:
            return {
                ...
                "summary": "VirusTotal API key is invalid or expired."
            }
        elif response.status_code == 404:
            return {
                "source": "VirusTotal_File",
                "finding": file_hash,
                "result": {"malicious": 0, "suspicious": 0, "harmless": 0, "undetected": 0},
        ...
        return {
            ...
            "summary": f"Scan results: {stats.get('malicious', 0)} malicious, {stats.get('suspicious', 0)} suspicious"
        }
        ...
        return {
            ...
            "finding": file_hash,
            "result": {"error": str(e)},
            "summary": f"VT API request failed: {str(e)}"
        }
